        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className={`rounded-lg p-4 border ${
            ...
            <div className={`text-2xl font-bold ${
              ...
              {aiConfigStatus.configured ? aiConfigStatus.provider : "关键词分析"}
            </div>
          ...
          {/* AI 用量（预留，Sprint 5 实现） */}
          <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4 border border-blue-200 dark:border-blue-800 opacity-50">
            <div className="text-sm text-blue-600 dark:text-blue-400 mb-1">
              本月用量
            </div>
          ...
          {/* 计费信息（预留，Sprint 5 实现） */}
          <div className="bg-purple-50 dark:bg-purple-900/20 rounded-lg p-4 border border-purple-200 dark:border-purple-800 opacity-50">
            <div className="text-sm text-purple-600 dark:text-purple-400 mb-1">
              本月费用
            </div>
