...
1. **下载扩展包**
   ...
   - 下载最新版本的 `chrome-mv3-prod-v0.6.2.zip`
   - 解压到任意目录
...
> 💡 **版本说明**：当前版本为 v0.6.2（2026-01-26），包含清单模式数据一致性修复、完整国际化支持等重要更新。
>
> **主要版本历程**（自 v0.3.6 以来，279 次提交）：
> - **v0.6.x 系列**：AI 中文摘要、全文抓取、数据一致性修复、完整国际化
> - **v0.5.x 系列**：阅读列表模式、AI 策略决策系统、Feed 级翻译设置、可视化 Feed 管理、Google Translate URL 去重修复
>
...
- **彩色方块进度条**：每个方块代表一篇文章
  ...
  - 💙 推荐（深绿）：推荐给您
  - 💙 已处理（蓝色）：已阅读或跳过
- **推荐漏斗恒等式**：可视化文章从源到推荐的完整流程
- **悬停显示详情**：将鼠标悬停在方块上查看详细统计
...
**Google Translate URL 支持（v0.5.1）** 🌐
- 自动识别并转换翻译页面的 RSS 链接
- 防止重复订阅相同的源
- 完整的 translate.goog URL 处理

<div align="center">
   <img src="assets/screenshots/screenshot-2-rss-settings-cn.png" width="720" alt="RSS 设置" />
   <br/>
