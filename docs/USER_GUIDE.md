...
> 🚧 **即将上线**：扩展正在审核中，即将在 Chrome Web Store 上架

1. 访问 [Chrome Web Store](https://chrome.google.com/webstore)
2. 搜索 "Silent Feed" 或直接访问扩展页面
3. 点击"添加至 Chrome"按钮
4. 确认权限请求
5. 安装完成后会自动打开引导页面
...
**步骤 2：AI 配置（可选）**
- 选择 AI 引擎（DeepSeek / OpenAI / Anthropic）
- 输入 API Key
- 测试连接
- **或者跳过**：使用免费的规则引擎
...
Silent Feed 需要收集 **100 个有效页面访问** 才能开始推荐：
